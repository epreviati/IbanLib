...
{
    /// <summary>
    ///     CountryCodeValidator class that permits to validate a Country Code.
    /// </summary>
    public class CountryCodeValidator : ICountryCodeValidator
    {
        public static readonly string[] AllCountryCodes =
        {
        ...
        ///     True/False
        /// </returns>
        public bool IsValid(string countryCode)
        {
            return !string.IsNullOrWhiteSpace(countryCode)
                   && countryCode.Length == 2
                   && AllCountryCodes.Contains(countryCode.ToUpperInvariant());
        }
    }
}